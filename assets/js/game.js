...
// functino to check if player wants to fight or skip
var fightOrSkip = function() {
    ...
    if (promptFight === "" || promptFight === null) {
        ...
        // use return call to call it again and stop the rest of the function from running.
        return fightOrSkip();
    }
...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
        //ask player if theyd like to fight or run using the fightOrSkip function 
        if (fightOrSkip()){
...
for(var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
        ...
        //pass the pickedenemy.name variables value into the fight function, where it will assume the value of the enemy parameter
...
var endGame = function() {
    ...
    // check localStorage for hight score, if it is not there, use 0
